...
public class GameCreator
{
    ...
    private GameCreator()
    {
        ...
        //Door
        {
            ...
            Open open = new Open(openEnforcer);
            Used used = new Used(needle, item => openEnforcer.unlock(item));
            Collide collide = new Collide(() => !open.isOpen);
            Entity defaultDoor = map.getAutoGeneratedDoor(getRoom("spawn"));

            Renders renders = new Renders(Icons.get("doorOpen"), Icons.get("doorClosed"), () => open.isOpen);
        ...
        // Dog
        {
            ...
            Renders renders = new Renders(Icons.get("dogHungry"), Icons.get("dogFed"), () => dogHungry);
        ...
        // Guard
        {
            ...
            OnLoad onLoad = new OnLoad(() => Program.gameState = GameStates.LOSE);
        ...
        // Escape
        {
            ...
            OnLoad onLoad = new OnLoad(() => Program.gameState = GameStates.WIN);
