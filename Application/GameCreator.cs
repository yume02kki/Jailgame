...
public class GameCreator
{
    ...
    public GameStates GameStates = GameStates.ONGOING;
    ...
    private GameCreator()
    {
        ...
        {
            bool dogHungry = true;
            Entity dogDoor = init.getAutoGeneratedDoor(rooms["dog"], Directions.UP);
        ...
        //Guard
        {
            ...
            OnLoad kill = new OnLoad(() => GameStates = GameStates.LOSE);
        ...
        {
            Renders render = new Renders(new Render("♕", ConsoleColor.Yellow));
            OnLoad win = new OnLoad(() => GameStates = GameStates.WIN);
